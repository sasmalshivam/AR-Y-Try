...
const TryOn = () => {
  ...
  const productData = {
    fashion: [
      ...
      { id: 41, name: 'Midnight Essential', price: '5299', image: '/src/assets/products/fashion/1.png' },
      { id: 42, name: 'Arctic White Tee', price: '3499', image: '/src/assets/products/fashion/2.png' },
    ],
    eyewear: [
    ...
    jewelry: [
      { id: 7, name: 'Diamond Studs', price: '24999', image: '/src/assets/products/jewelry/1.png' },
      { id: 8, name: 'Gold Hoops', price: '18999', image: '/src/assets/products/jewelry/2.png' },
      { id: 71, name: 'Silver Drops', price: '12999', image: '/src/assets/products/jewelry/1.png' },
      { id: 72, name: 'Rose Gold Studs', price: '21499', image: '/src/assets/products/jewelry/2.png' },
    ],
    beauty: [
